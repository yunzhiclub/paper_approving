	...
	<div class="row-fluid">
		<div class="span12">
			...
			<p>
                ...
                6.提交评阅内容：在 <a href="{:U('ReviewDetail/index')}">评阅论文</a> 栏目中，点击 提交 ，出现操作成功，数据即保存成功。在系统开放日期内，您可以随时登陆系统进行评阅意见的修改并重新提交。<br />
                7.<a href="{:U('Login/logout')}">注销登陆</a><br /><br />
                联系电话：022-60204129, 邮箱：364258082@qq.com,联系人：候老师;
