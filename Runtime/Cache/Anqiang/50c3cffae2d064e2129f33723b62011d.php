...
*{ margin:0; padding:0}
html{ height:100%}
body{ background:url(/Ethan-wechat/Public/img/body.png) center top; height:100%}
...
.stepA{ background:url(/Ethan-wechat/Public/img/guide1.png); height:329px; width:745px; top:130px; left:-9px; display:block}
.stepA a{top:230px; left:490px; }
.stepA span{ top:143px; right:32px; }
.stepB{ background:url(/Ethan-wechat/Public/img/guide2.png); width:647px; height:405px;top:2px; left:324px}
.stepB a{top:308px; left:146px;}
.stepB span{ top:196px; right:285px; }
.stepC{ background:url(/Ethan-wechat/Public/img/guide3.png); width:654px; height:257px;top:294px; left:318px}
.stepC a{top:155px; left:400px; }
.stepC span{ top:44px; right:35px; }
.stepD{ background:url(/Ethan-wechat/Public/img/guide4.png); width:558px; height:348px;top:78px; left:155px}
.stepD a{top:246px; left:304px;}
.stepD span{ top:135px; right:35px; }
.stepE{ background:url(/Ethan-wechat/Public/img/guide5.png); width:397px; height:342px;top:79px; left:250px}
.stepE a{top:245px; left:153px;}
</style>
<script type="text/javascript" src="/Ethan-wechat/Public/js/jquery-1.7.min.js"></script>
