...
<table>
	<tr>
		...
		<?php else: ?> <?php echo U('index?by=id&order=desc', I('get.')); endif; ?>">活动编号</a></th>
		<th>缩略图</th>&nbsp
		<th>活动名</th>&nbsp
		<th>活动结束时间</th>&nbsp
		<th>活动详情</th>&nbsp
	...
	<?php if(is_array($activities)): foreach($activities as $k=>$activity): ?><tr>
		<th><?php echo ($k+1); ?></th>&nbsp
		<th><?php echo ($activity[id]); ?></th>&nbsp
		<th><img class="thumbnail" src="<?php echo ($activity[thumbnails_url]); ?>" /></th>&nbsp
		<th><?php echo ($activity[title]); ?></th>&nbsp
		<th><?php echo ($activity[end_time]); ?></th>&nbsp
		<th><?php echo ($activity[detail]); ?></th>&nbsp
		<th><?php echo ($activity[status]?'正常':'冻结'); ?></th>&nbsp
		<td><a class="button" href="<?php echo U('detail?id='.$activity['id']);?>">查看</a>&nbsp;&nbsp;
		<a class="button" href="<?php echo U('edit?id='.$activity['id']);?>">编辑</a>&nbsp;&nbsp;
		<a class="button" href="<?php echo U('delete?id='.$activity['id']);?>">删除</a></td>
	</tr><?php endforeach; endif; ?>
</table>


</form>
<?php $page = new Think\Page(5,2);echo $page->show(); ?>
<style type="text/css">
.thumbnail{
	height: 50px;
}
