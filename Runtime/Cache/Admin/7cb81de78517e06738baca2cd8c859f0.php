...
<body>
	...
	<form <?php if((ACTION_NAME) == "add"): ?>action="<?php echo U('save',I('get.'));?>"<?php else: ?>action="<?php echo U('update',I('get.'));?>"<?php endif; ?> method="post">
		<input type="hidden" name="id" value="<?php echo ($slideshow["id"]); ?>">
		</input>
		<label>
			标题：
		</label>
		<input type ="text" name="title" value="<?php echo ($slideshow["title"]); ?>" />
		</br>
		<label>缩略图：</label>
		<?php if((ACTION_NAME) == "edit"): ?><img class="suoluetu"   src="<?php echo ($slideshow[url]); ?>"  />
			</br>
		...
		<label>权重：</label>
		<input type = "text" name="weight" value="<?php echo ($slideshow["weight"]); ?>"/>
		</br>
		<label>状态：</label>
		<select name="status" value="<?php echo ($slideshow["weight"]); ?>">
	  			<option name="type" value="<?php echo ($slideshow["status"]); ?>">正常</option>
	  			<option name="type" value="<?php echo ($slideshow["status"]); ?>">冻结</option>
	    </select>
		</br>
