    ...
    <div id="page-wrapper">
        ...
        <div class="row-fluid">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <div class="panel-body">
                        	<a class="button btn btn-info"  href="<?php echo U('add');?>" >添加</a>
                        </div>
			...
			<th>操作</th>
				...
				<td><a class="btn btn-sm btn-success" href="<?php echo U('detail?id='.$slideshow['id'].'&p='.I('get.p'));?>">查看</a>&nbsp;&nbsp;
				<a class="btn btn-sm btn-success" href="<?php echo U('edit?id='.$slideshow['id'].'&p='.I('get.p'));?>">编辑</a>&nbsp;&nbsp;
				<a class="btn btn-sm btn-success" href="<?php echo U('delete?id='.$slideshow['id'].'&p='.I('get.p'));?>">删除</a></td>
                    ...
                    <nav>
                        <?php $page = new Think\Page(21,10);echo $page->show(); ?>
