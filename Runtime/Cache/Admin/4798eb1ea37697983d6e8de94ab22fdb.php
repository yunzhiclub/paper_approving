...
<body>
	...
	<input type="hidden" name="id" value="<?php echo ($introduction["id"]); ?>"></input>
	<label>电话：</label><input type ="text" name="hotel_phone" value="<?php echo ($introduction["hotel_phone"]); ?>" /></br>	
	<label>酒店介绍：</label><input type = "text" name="description" value="<?php echo ($introduction["description"]); ?>"/></br>
