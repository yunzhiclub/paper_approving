...
<body>
	...
	<form <?php if((ACTION_NAME) == "add"): ?>action="<?php echo U('save');?>"<?php else: ?>action="<?php echo U('update');?>"<?php endif; ?> method="post">
	<input type="hidden" name="id" value="<?php echo ($activity["id"]); ?>"></input>
	<label>活动名称：</label><input type ="text" name="title" value="<?php echo ($activity["title"]); ?>" /></br>
	<label>缩略图：</label>
	<?php if((ACTION_NAME) == "edit"): ?><img class="thumbnail"   src="<?php echo ($activity[thumbnails_url]); ?>"  /></br>
	<label>上传新图片：</label><?php endif; ?>
	
	<div id="uploader" class="ourClass">
            <input type="hidden" id="yunzhifiles" name="thumbnails_url" />
            <div class="queueList">
	...
	<label>截止时间：</label><input type = "text" name="end_time" value="<?php echo ($activity["end_time"]); ?>"/></br>
	<label>状态：</label><input type ="text" name="status" value="<?php echo ($activity["status"]); ?>" /></br>
