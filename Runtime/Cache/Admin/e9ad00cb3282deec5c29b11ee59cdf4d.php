...
<label>活动编号:<?php echo ($activity[id]); ?></label></br>
<label>活动名称:<?php echo ($activity[title]); ?></label></br>
<label>活动缩略图:</label><img class="thumbnail" src="<?php echo ($activity[thumbnails_url]); ?>" /></br>
<label>活动详情:<?php echo ($activity[detail]); ?></label></br>
<label>状态:<?php echo ($activity[status]); ?></label></br>
<style type="text/css">
	.thumbnail{
		height: 50px;
	}
