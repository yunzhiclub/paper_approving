<?php if (!defined('THINK_PATH')) exit();?>var webuploader = function( $ ){
    // 当domReady的时候开始初始化
    $(function() {
        var $wrap = $('#uploader'),
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            if (flashVersion) {
                (function(container) {
                    ...
                    var swf = '/ethan-wechat/Public/lib/webuploader/swf/expressInstall.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '/ethan-wechat/Public/lib/webuploader/swf/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/ethan-wechat/Public/yunzhi.php/webuploader/upload.html?action=uploadimage',
            // runtimeOrder: 'flash',
