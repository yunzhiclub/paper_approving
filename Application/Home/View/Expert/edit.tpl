...
<input type="hidden" name="id" value="{$expert.id}"></input>
<div>
...
<div><label for="tutor_class">导师类别（博导/硕导）</label>
<input type="text" id="tutor_class" name="tutor_class" value="{$expert.tutor_class}">
</div>
<div><label for="email">电子邮编</label>
...
<div><label for="userpassword">密码</label>
